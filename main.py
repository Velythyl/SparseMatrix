...
# Note: les quads sont de forme (k,i,j,valeur): ceci est plus logique pour la generalisation
...
test = SparseDict(quads, (60000, 28, 28)).todense()
...
try:
    print("Comparaison...")
    if sorted(tridbitmap) != sorted(test):
        raise AssertionError
